...
public class PatientListAjax {
	List<PatientMedicalHistory> item;
	String searchVal;
	Integer page;
	Integer countItem;
	Integer page1;
	...
	public PatientListAjax() {
		super();
		// TODO Auto-generated constructor stub
	}


	public List<PatientMedicalHistory> getItem() {
		return item;
	}


	public void setItem(List<PatientMedicalHistory> item) {
		this.item = item;
	}
