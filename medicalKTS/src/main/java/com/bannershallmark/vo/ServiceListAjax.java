...
public class ServiceListAjax {
	List<MedicService> medicServices;
	String searchVal;
	Integer page;
	Integer countItem;
	Integer page1;
	...
	public ServiceListAjax() {
		super();
		// TODO Auto-generated constructor stub
	}


	public List<MedicService> getMedicServices() {
		return medicServices;
	}

	public void setMedicServices(List<MedicService> medicServices) {
		this.medicServices = medicServices;
	}
