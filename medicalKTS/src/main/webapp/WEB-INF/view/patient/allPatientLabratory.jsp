...
<body>
			...
			<div class="page-heading">
				...
				<section class="section blnk-db ">
								...
								<div class="col-sm-3 col-12">
									<fieldset class="form-group">
										...
										<select class="form-select dropdown-group" name="orderBy" id="orderBy">
											...
											<option value="2">Order by Date ASC</option>
								...
								<div class="col-sm-3 col-6">
									<fieldset class="form-group">
										...
										<select class="form-select dropdown-group" name="byType" id="byType">
											...
											<option value="1">Dr.Ermi</option>
											<option value="2">Dr.Abe</option>
										</select>
									</fieldset>
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col-4 c-dflx justify-content-between">
	...
	var aoColumns = [{
			...
			"mData" : null,
			"mRender" : function(data) {
				var status = "<div class='action-buttons'><a class='red' href='${pageContext.request.contextPath}/Patient/editMedicHistorylabratory/"+data.id+"' target='_blank'><i class='bi bi-eye-fill'></i></a></div>";
				return status;
			}
		}];
