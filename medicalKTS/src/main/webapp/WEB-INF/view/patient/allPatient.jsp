...
<body>
	...
	var aoColumns = [{
			...
			"mData" : null,
			"mRender" : function(data) {
				var status = "<div class='action-buttons'><a class='red' href='${pageContext.request.contextPath}/Patient/patientHistory/"+data.id+"' target='_blank'><i class='bi bi-eye-fill'></i></a></div>";
				return status;
			}
		}];
