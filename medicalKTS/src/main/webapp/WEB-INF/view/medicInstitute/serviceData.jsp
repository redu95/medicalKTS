							...
							<div class="card-body">
								<div class="row">
									<div class="col-sm-3 col-12">
										<fieldset class="form-group">
											...
											<select class="form-select dropdown-group" name="orderBy" id="orderBy">
												...
												<option value="2">Order by Price ASC</option>
									...
									<div class="col-sm-3 col-6">
										<fieldset class="form-group">
											<label for="byDept" class="form-label">By Department</label>
											<select class="form-select dropdown-group" name="byDept" id="byDept">
									...
									<div class="col-sm-3 col-6">
										<fieldset class="form-group">
											<label for="byType" class="form-label">By Type</label>
					        ...
					        <div class="modal-dialog modal-lg" role="document">
					            <div class="modal-content">
					                <div class="modal-header">
					                    <h5 class="modal-title" id="newServiceModalLabel">Register New Service</h5>
