			...
			<div class="page-heading">
				...
				<section class="section blnk-db">
					<form:form class="form-horizontals" method="post" id="user_form"
						onsubmit="saveForm()" name="user_form" action="${pageContext.request.contextPath}/Institute/addServiceData"
									...
									<div class="col-6">
										<div class="form-group">
											...
											<form:select type="text" name="departmentName" id="departmentName"
												...
												value="">
												<form:option value="${service.departmentName}">${service.departmentName}</form:option>
						...
						<div class="row">
							<div class="col-12 d-flex justify-content-center">
								<a href="${pageContext.request.contextPath}/Institute/serviceData"
