...
<body>
	...
	<script>
		...
		$('#plusIcon').on('click',function(){
			...
			$(lastChild).after('<div class="form-group datetimepick"> <div class="input-group"><select id="startHour'+sequenceNumber+'" class="form-select selectVals rowgroup'+sequenceNumber+' startHour'+sequenceNumber+'" onchange="readScheduleDate('+sequenceNumber+',this.value,this)"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp; &nbsp; &nbsp;<select id="startMinute'+sequenceNumber+'" class="form-select selectVals rowgroup'+sequenceNumber+' startMinute'+sequenceNumber+'" onchange="readScheduleDate('+sequenceNumber+',this.value,this)"> <option value="00">00</option><option value="15">15</option><option value="30">30</option><option value="45">45</option> </select></div> <div class="form-check mt-3"><div class="checkbox"><input type="checkbox" name="checkAll" class="form-check-input selectVals">Free slot</div></div></div>');
		...
		function readScheduleDate(rowSequence,currentVal, lineVal){
			...
			if(secondVal=='00'){
				secondVal='15';
			} else if(secondVal=='15'){
				secondVal='30';
			} else if(secondVal=='30'){
				secondVal='45';
			} else if(secondVal=='45'){
				secondVal='59';
			}
