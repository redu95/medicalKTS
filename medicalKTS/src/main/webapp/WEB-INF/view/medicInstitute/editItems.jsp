								...
								<div class="row">
									<div class="col-12">
										<div class="form-group">
											...
											<textarea name="description" rows="3" id="description" class="form-control" placeholder="">Sterilizer item description</textarea>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-4">
										<div class="form-group">
											...
											<form:input type="number" maxlength="50" name="totalQuanitiy"
												...
												placeholder="" value="80" required="true" />
										</div>
									</div>
									<div class="col-4">
										<div class="form-group">
											...
											<form:input type="number" maxlength="50" name="minimunStock"
												...
												placeholder="" value="20" required="true" />
										</div>
									</div>
									<div class="col-4">
										<div class="form-group">
