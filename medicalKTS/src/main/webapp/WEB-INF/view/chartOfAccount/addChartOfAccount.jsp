...
<html>
<head>
<title>Banners Hallmark - Add Chart Of Account</title>
</head>
<body>
                ...
                <div class="page-heading">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Add Chart Of Account
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <section class="section blnk-db">
                       <form:form class="form" method="post" id="user_form"
						name="user_form" action="addNewChartOfAccount" onsubmit="saveForm()"  modelAttribute="chartOfAccount">
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <form:input type="text" maxlength="7" name="accountNumber" id="accountNumber"
															...
															placeholder="Account Number" value="" required="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <form:input type="date" name="created" id="created"
																	path="created" class="datePicker form-control"
                                        ...
                                        <div class="col-md-4 col-12">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <form:input type="date" name="updated" id="updated"
																	path="updated" class="datePicker form-control"
