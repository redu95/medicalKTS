...
<head>
 ...
 <body valign="middle" align="center" style="height: 100%;vertical-align:middle">
  <div class="main" align="center" valign="middle"><div><div align="center">&nbsp;</div>
   ...
   <form:form class="form-horizontals" method="post" id="user_form" name="user_form" action="${pageContext.request.contextPath}/newResetPassword/${randomId}" modelAttribute="users">
